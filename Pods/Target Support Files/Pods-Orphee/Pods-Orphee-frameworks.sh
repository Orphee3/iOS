...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Orphee/NextGrowingTextView.framework"
  install_framework "Pods-Orphee/OAuthSwift.framework"
  ...
  install_framework "Pods-Orphee/SwiftWebSocket.framework"
