...
public protocol pFormattedFileManager: class {
    ...
    ///                 - `false` otherwise.
    func createFile(name: String?, content: [String : Any]?) -> Bool;
...
public protocol pFormattedFileManagerWithDataCreator: pFormattedFileManager {

    typealias dataCreatorType;
}